...
import de.jotschi.vertx.loom.db.jooq.Indexes;
...
public class User extends TableImpl<UserRecord> {
     ...
     */
    public final TableField<UserRecord, Boolean> ENABLED = createField(DSL.name("enabled"), SQLDataType.BOOLEAN.defaultValue(DSL.field("true", SQLDataType.BOOLEAN)), this, "");
